...
The point of this kata to provide a larger than trivial exercise that can be used to practice TDD.  A significant
portion of the effort will be in determining what tests should be written and, more importantly, written next.


How to Run*
====================
go to /api -> run yarn install && yarn start 
go to /e2e -> run yarn install && yarn test
...
Credit to Guy Royse for creating this kata. View the original here: https://github.com/guyroyse/vending-machine-kata